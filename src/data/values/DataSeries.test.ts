...
describe("DataSeries", () =>
{
    describe("init DataSeries instance and get_entries", () =>
    {
        it("should accept valid initial data", () =>
        {
            ...
            const series = new DataSeries<string, number>(initial_data)
        ...
        {
            const series = new DataSeries<string, number>([])
    ...
    describe("get method", () =>
    {
        ...
        {
            const series = new DataSeries<string, number>(["a", "b"], (key: number) => key - 1)
